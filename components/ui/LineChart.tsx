      ...
      >
        <defs>
          <linearGradient id={`${uid}-fill`} x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#10b936" stopOpacity="0.2" />
            <stop offset="58%" stopColor="#10b936" stopOpacity="0.05" />
            <stop offset="100%" stopColor="#10b936" stopOpacity="0" />
          </linearGradient>
          <linearGradient id={`${uid}-line`} x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#10b936" stopOpacity="0.55" />
            <stop offset="38%" stopColor="#10b936" stopOpacity="1" />
            <stop offset="100%" stopColor="#6ee789" stopOpacity="1" />
          </linearGradient>
        </defs>
        ...
        <circle
          ...
          r="3.5"
          fill="#10b936"
          className="[filter:drop-shadow(0_0_7px_rgba(16,185,54,0.85))]"
        />
        ...
        {active && (
          <g>
            <line
              ...
              strokeDasharray="3 4"
            />
            <circle cx={active.x} cy={active.y} r="9" fill="rgba(16,185,54,0.2)" />
            <circle cx={active.x} cy={active.y} r="4" fill="#10b936" stroke="#060a16" strokeWidth="2.5" />
          </g>
        )}
      </svg>
