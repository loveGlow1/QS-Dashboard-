...
import { getActiveInvestment, getPortfolio, getProfile, getTransactions } from "@/lib/data";
...
export default async function DashboardPage() {
  ...
  return (
    <>
      ...
      <section className="mb-4 grid gap-4 min-[1025px]:grid-cols-[minmax(0,1fr)_minmax(0,380px)]">
        <RecentActivity transactions={transactions} />
        <ActiveInvestment investment={investment} />
      </section>
